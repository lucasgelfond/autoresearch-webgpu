<script lang="ts">
	...
	let { experiments, bestConfig }: { experiments: ExperimentRecord[]; bestConfig: ExperimentConfig } = $props();
</script>

<div class="space-y-2 max-h-96 overflow-y-auto">
	{#each [...experiments].reverse() as exp}
		<div class="rounded border px-3 py-2 text-sm font-mono {exp.kept ? 'border-green-800 bg-green-950/30' : 'border-gray-800'}">
